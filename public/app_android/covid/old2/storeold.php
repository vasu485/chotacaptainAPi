...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	{   
		...
		$query = "INSERT INTO users (fname,lname,empid,agree,interestedToApply,total_premium,emp_sum_insured,emp_plan,emp_age,spouse_name,spouse_insured_amount,spouse_plan,spouse_age,m_name,m_insured_amount,m_plan,m_age,f_name,f_insured_amount,f_plan,f_age,c1_name,c1_insured_amount,c1_plan,c1_age,c2_name,c2_insured_amount,c2_plan,c2_age,c3_name,c3_insured_amount,c3_plan,c3_age,eprm,sprm,mprm,fprm,c1prm,c2prm,c3prm,mil_name,mil_insured_amount,mil_plan,mil_age,fil_name,fil_insured_amount,fil_plan,fil_age,milprm,filprm) VALUES ('$firstName','$lastName','$empid','$agree','$interestedToApply','$total_premium','$emp_sum_insured','$emp_plan','$emp_age','$sname','$samount','$splan','$sage','$mname','$mamount','$mplan','$mage','$faname','$famount','$fplan','$fage','$c1name','$c1amount','$c1plan','$c1age','$c2name','$c2amount','$c2plan','$c2age','$c3name','$c3amount','$c3plan','$c3age','$eprm','$sprm','$mprm','$fprm','$c1prm','$c2prm','$c3prm','$milname','$milamount','$milplan','$milage','$failname','$filamount','$filplan','$filage','$milprm','$filprm')";
